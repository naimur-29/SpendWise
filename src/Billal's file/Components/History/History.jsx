    ...
    <>
      <div className="HistoryContainer h-full bg-gray-300">
        <div className="HistoryContainerWrapper px-2">
          <h1 className="mb-2 text-2xl font-semibold">Expenses</h1>
          <div className="bodyContainer grid grid-cols-12">
            {/* left side of body starts  */}
            <div className="bodyLeft col-span-7">
              ...
              <div className="twoCardContainer  mt-2 mb-2 grid grid-cols-12">
                <div className="leftCard col-span-6">
                  <a
                    href="#"
                    className="block w-[94%] p-2 m-auto bg-white border border-gray-200 rounded-md shadow-md hover:bg-gray-100 text-center"
                  >
                    <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 ">
                      Total incomes
                    </h5>
                    <div className="incomeTaka flex justify-center">
                      <TbCurrencyTaka className="self-center text-2xl" />
                      <p class="font-normal text-2xl text-gray-800 ">
                        1200 taka
                      </p>
                    </div>
                  </a>
                ...
                <div className="rightCard col-span-6">
                  ...
                  >
                    ...
                    <div className="incomeTaka flex justify-center">
                      <TbCurrencyTaka className="self-center text-2xl" />
                      <p class="font-normal text-2xl ">1200 taka</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="singleContainer">
                <a
                  href="#"
                  className="block w-[60%] p-2 m-auto bg-white border border-gray-200 rounded-md shadow-md hover:bg-gray-100 text-center"
                >
                  <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 ">
                    Total Balance
                  </h5>
                  <div className="incomeTaka flex justify-center">
                    <TbCurrencyTaka className="self-center text-2xl text-green-600" />
                    <p class="font-normal text-2xl text-green-600 ">
                      1200 taka
                    </p>
                  </div>
                </a>
            ...
            <div className="bodyRight col-span-5 p-3">
