      ...
      <section className="min-h-screen w-full bg-[--main-dashboard-bg] transition-[background-color] duration-[1000ms] md:w-[calc(100%-16rem)]">
        <div className="_wrapper flex h-full w-full flex-col">
          <div className="_top flex w-full items-center justify-between gap-2 px-[20px] pb-[16px] pt-[20px] sm:gap-1 md:px-[27px] md:pb-[20px]">
            <div className="_left">
              <h3 className="text-lg font-semibold text-[--main-text] extra-sm:text-2xl sm:text-3xl">
                Welcome to SpendWise!
              </h3>
              <p className="text-sm text-[--light-dashboard-text] extra-sm:text-lg">
            ...
            <div className="_right flex items-center justify-center">
              <button
                ...
                className="min-w-[110px] rounded-lg bg-[--main-btn-bg] p-2 text-lg font-semibold uppercase text-slate-100 shadow-lg duration-200 hover:scale-95 hover:bg-[#2c8781] hover:shadow-md active:scale-100 sm:px-8 sm:py-2"
              >
                Sign Out
              </button>
            </div>
          ...
          <div className="_bottom h-full w-full px-[10px] pb-[10px] md:px-[20px] md:pb-[20px]">
            <div className="_wrapper flex h-full max-h-[100%] w-full flex-col gap-[20px] overflow-x-hidden rounded-3xl bg-[--main-dashboard-overBg] p-[10px] transition-[background-color] duration-300 sm:p-[20px] lg:flex-row">
